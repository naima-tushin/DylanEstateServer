...
app.use(cors({
    origin: ['http://localhost:5000', 'http://localhost:5173', 'https://dylan-estate-tushin.netlify.app/sellerHomePage', 'https://dylan-server-side-oe32pu0sa-naima-tushins-projects.vercel.app/']
}));
